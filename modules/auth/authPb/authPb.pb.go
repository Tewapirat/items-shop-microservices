...
const file_modules_auth_authPb_authPb_proto_rawDesc = "" +
	"\n" +
	" modules/auth/authPb/authPb.proto\"9\n" +
	"\x14AccessTokenSearchReq\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\"1\n" +
	"\x14AccessTokenSearchRes\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid\"\x0f\n" +
	"\rRolesCountReq\"%\n" +
	...
	"\tRoleCount\x12\x0e.RolesCountReq\x1a\x0e.RolesCountResB$Z\"github.com/TewApirat/items-shop-msb\x06proto3"
