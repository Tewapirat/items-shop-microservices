...
func (UnimplementedAuthGrpcServiceServer) AccessTokenSearch(context.Context, *AccessTokenSearchReq) (*AccessTokenSearchRes, error) {
	return nil, status.Error(codes.Unimplemented, "method AccessTokenSearch not implemented")
}
func (UnimplementedAuthGrpcServiceServer) RoleCount(context.Context, *RolesCountReq) (*RolesCountRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RoleCount not implemented")
}
...
func RegisterAuthGrpcServiceServer(s grpc.ServiceRegistrar, srv AuthGrpcServiceServer) {
	// If the following call panics, it indicates UnimplementedAuthGrpcServiceServer was
