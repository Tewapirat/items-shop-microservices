...
import (
	...
	"github.com/TewApirat/items-shop-ms/modules/middleware/middlewareHandler"
...
func newMiddleware(cfg *config.Config)middlewareHandler.MiddlewareHandlerService{
	repo := middlewareRepository.NewMiddlewareRepositoryHandler()
	usecase := middlewareUsecase.NewMiddlewareUasecase(repo)
